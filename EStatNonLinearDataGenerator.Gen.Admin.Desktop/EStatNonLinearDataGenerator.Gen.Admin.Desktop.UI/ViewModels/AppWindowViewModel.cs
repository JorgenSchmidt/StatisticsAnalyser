using EStatNonLinearDataGenerator.Gen.Admin.Desktop.Core.Configurations;
using EStatNonLinearDataGenerator.Gen.Admin.Desktop.Core.Entities.DataEntities;
using EStatNonLinearDataGenerator.Gen.Admin.Desktop.Core.Entities.GraphicsEntities;
using EStatNonLinearDataGenerator.Gen.Admin.Desktop.Core.Enums;
using EStatNonLinearDataGenerator.Gen.Admin.Desktop.Model.DataServices;
using EStatNonLinearDataGenerator.Gen.Admin.Desktop.Model.FileServices;
using EStatNonLinearDataGenerator.Gen.Admin.Desktop.Model.GraphicsShell;
using EStatNonLinearDataGenerator.Gen.Admin.Desktop.UI.AppService;
using System;
using System.Collections.Generic;
using System.Windows;

namespace EStatNonLinearDataGenerator.Gen.Admin.Desktop.UI.ViewModels
{
            ...
            get
            {
                return new Command(
                    obj =>
                    {
                        ...
                        {
                            MessageBox.Show("Минимальное значение генерации не может быть больше или равно максимальному.");
                            return;
                        }
